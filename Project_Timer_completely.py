...
def timer(): # หน้าหลักสำหรับเลือก 2 ฟังก์ชัน
    ...
    def timer_countdown(): # ฟังก์ชันสำหรับนับเวลาถอยหลัง
        class Countdown(tk.Frame):
            ...
            def create_widgets(self): # ฟังก์ชันในการแสดงผลของเวลา ช่องสำหรับใส่เวลา และ ปุ่มstart
            ...
            def start_button(self): # ฟังก์ชันที่ทำให้ปุ่ม start ทำงาน
